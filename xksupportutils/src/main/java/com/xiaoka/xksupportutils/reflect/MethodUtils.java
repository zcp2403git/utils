...
package com.xiaoka.xksupportutils.reflect;
...
public class MethodUtils {
    ...
    public static Method getAccessibleMethod(final String clsName, final String methodName,
                                             final Class<?>... parameterTypes) throws NoSuchMethodException {

        try {
            Class<?> aClass = Class.forName(clsName);
            return getAccessibleMethod(aClass, methodName, parameterTypes);
    ...
    public static Object invokeMethod(final String className, final String methodName,
        ...
        Class<?> aClass = ClassUtils.getClassForName(className);
         Class<?>[] parameterTypes= ClassUtils.toClass(args);
        parameterTypes = ClassUtils.nullToEmpty(parameterTypes);
        args = ClassUtils.nullToEmpty(args);
    ...
    public static void invokeMethod(final String clsName, final String methodName) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InstantiationException, InvocationTargetException {
            Class<?> aClass = Class.forName(clsName);
